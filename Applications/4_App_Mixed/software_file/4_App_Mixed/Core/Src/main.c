...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, Buzzer_Pin|State_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Buzzer_Pin State_LED_Pin */
  GPIO_InitStruct.Pin = Buzzer_Pin|State_LED_Pin;
